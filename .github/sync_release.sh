...
UPSTREAM_REPO="https://github.com/MiSTer-devel/PokemonMini_MiSTer.git"
CORE_NAME=(PokemonMini)
...
UPSTREAM_CORE_NAME=(PokemonMini)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(pokemon_mini.qpf)
COMPILATION_OUTPUT=(output_files/pokemon_mini.rbf)
